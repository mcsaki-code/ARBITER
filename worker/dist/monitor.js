...
exports.scanMarketPrices = scanMarketPrices;
 ...
 */
async function scanMarketPrices(supabase) {
    ...
    for (const market of markets) {
        ...
        if (shift >= 0.03) {
            ...
            console.log(`[monitor] 🔔 Price shift: ${market.category} "${market.question.substring(0, 60)}" ` +
